...
str(npk)
```
The labelled columns now have an attribute `label` that contains the variable label,
and are now of class `tiny_labelled` that extend the simple vector classes (e.g., logical, integer, double, etc.)
...
Tu further support *tidyverse*-ish code,
